...
Login exits after the daemon becomes healthy. Configure an OpenAI-compatible client with base URL `http://127.0.0.1:65443/v1`. The client never receives or stores the Athenz AT.

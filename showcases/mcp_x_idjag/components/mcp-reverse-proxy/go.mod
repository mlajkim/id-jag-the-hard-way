module github.com/mlajkim/id-jag-the-hard-way/showcases/mcp_x_idjag/patterns/pattern-3a-remote-return/mcp-reverse-proxy

go 1.26.4

require (
	github.com/AthenZ/athenz-authorizer/v5 v5.8.4
...
require (
	...
	github.com/kpango/gache/v2 v2.1.10 // indirect

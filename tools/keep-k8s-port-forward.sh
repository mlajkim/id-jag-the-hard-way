...
_agentgateway_admin_port=$(resolve_port agentgateway-admin)
...
_pf mcp     service/mcp                   "${_mcp_port}"               8081 &
...
_pf agent-gateway deployment/agentgateway-proxy "${_agentgateway_admin_port}" 15000 &

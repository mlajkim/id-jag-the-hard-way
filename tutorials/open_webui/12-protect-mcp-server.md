...
- [Attach the Access Token with the New Scope](#attach-the-access-token-with-the-new-scope)
- [Verify](#verify)
...
Now, ask the AI Agent the exact same prompt:
...
## Attach the Access Token with the New Scope

...
Use the shared chapter's `curl` commands to see both failures independently of the client interface. Keep the proxy enabled and return to this client path for the next chapter.

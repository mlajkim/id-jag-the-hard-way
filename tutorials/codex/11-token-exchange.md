...
Codex can now retrieve documents through the protected MCP service. In the next chapter, you will deploy Keycloak so users can sign in and receive an ID token. Next: [Identity Provider](./12-identity-provider.md)

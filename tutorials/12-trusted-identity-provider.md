...
|:----------------------------------------------:|:-----------------------------:|:----------------------------------------------:|
| [Identity Provider](./11-identity-provider.md) | **Trusted Identity Provider** | [AI Client Gateway](./13-ai-client-gateway.md) |
...
![12_athenz_not_trusting_keycloak_yet](./assets/12_athenz_not_trusting_keycloak_yet.png)

Additionally, Athenz needs to be instructed on how to handle the specific token formats of external IdPs.
...
To do this, carefully follow the steps below to edit the ConfigMap using `vim` (the default editor for `kubectl`):
...
1. Press the `Spacebar` **exactly 4 times** to match the required YAML indentation.

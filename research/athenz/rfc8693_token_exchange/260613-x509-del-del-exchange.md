...
| 3 | Aug 29, 2026 | ✅ — manually reran the full flow; captured complete decoded JWT headers and claims; confirmed the expected wrong-actor failure and both delegated exchanges |
...
```sh
#   ✔  Member already exists: api.mcp-hub  →  api:role.to-api-exchanger
```
...
#   "exp": 1787964571,
#   "iat": 1787960971,
#   "jti": "b08abe8a-7bfc-49b2-b0ff-37193a7d0f42"
# }
```
...
#   "exp": 1787964593,
#   "iat": 1787960993,
#   "jti": "9f34fe2f-c2f4-4529-b2dd-981c35b6d9f4"
# }
```
...
#   "exp": 1787964599,
#   "iat": 1787960999,
#   "jti": "77b1c9bc-6946-43ad-b691-74aa7c9bd1bf"
# }
# {
